...
export default async function PublicationsPage({
  ...
  return (
    <>
      ...
      />
      <PublicationsView filters={filters} replicateAction={replicatePublicationAction} tiendanubeStatusBySourceKey={result.state === "error" ? {} : result.tiendanubeStatusBySourceKey} categories={result.state === "error" ? [] : result.categories} {...result} />
    </>
  );
}
